<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.explores.index_title')
        </h2>
    </x-slot>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        @can('update', $explore)
                                        <a
                                            href="{{ route('explores.edit', $explore) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $explore)
                                        <a
                                            href="{{ route('explores.show', $explore) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $explore)
                                        <form
                                            action="{{ route('explores.destroy', $explore) }}"
                                            method="POST"
