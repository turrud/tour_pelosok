<div class="container max-w-screen-xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
    ...
    <!-- Kolom Image 2 -->
    <div class="h-48">
        <img src="https://placehold.co/400x300" alt="Waterfall" class="w-full h-full object-cover rounded-lg">
    </div>

    <!-- Kolom Image 3 -->
    <div class="h-48">
        <img src="https://placehold.co/400x300" alt="Forest waterfall" class="w-full h-full object-cover rounded-lg">
    </div>
</div>
