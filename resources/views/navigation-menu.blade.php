        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if (Auth::user()->can('view-any', App\Models\User::class) ||
                    ...
                    Auth::user()->can('view-any', App\Models\About::class) ||
                    Auth::user()->can('view-any', App\Models\Tagabout::class) ||
                    Auth::user()->can('view-any', App\Models\People::class) ||
                    Auth::user()->can('view-any', App\Models\Package::class) ||
                    Auth::user()->can('view-any', App\Models\Tagpackage::class) ||
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        <x-dropdown-link href="{{ route('taghomes.index') }}">
                        Taghomes
                        </x-dropdown-link>
                        @endcan
                        ...
                        <x-dropdown-link href="{{ route('tagabouts.index') }}">
                        Tagabouts
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\People::class)
                        <x-dropdown-link href="{{ route('all-people.index') }}">
                        All People
                        </x-dropdown-link>
                        @endcan
                        ...
                        <x-dropdown-link href="{{ route('tagpackages.index') }}">
                        Tagpackages
                        </x-dropdown-link>
                        @endcan
                        ...
                        <x-dropdown-link href="{{ route('explores.index') }}">
                        Explores
                        </x-dropdown-link>
                        @endcan
